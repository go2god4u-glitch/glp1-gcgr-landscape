...
const comparison = {
  mazdutide: {
    ...
    discontinuation: "<b>GI AE 중단 0.3%</b>",
  ...
  survodutide: {
    ...
    discontinuation: "<b>GI AE 중단 약 19%</b>",
  ...
  pemvidutide: {
    ...
    discontinuation: "<b>전체 AE 중단 19.6%</b><br><small>GI 원인 미분리</small>",
  ...
  efino: {
    ...
    discontinuation: "<b>전체 AE 중단 5.6%</b><br><small>GI 원인 미분리</small>",
  ...
  dd01: {
    ...
    discontinuation: "<b>GI AE 중단 8.0%</b><br><small>biopsy-confirmed set</small>",
  ...
  da1726: {
    ...
    discontinuation: "<b>GI AE 중단 0/6</b>",
...
function applyColumnVisibility() {
  ...
  if (hiddenMasterColumns.has("mechanism")) closeRatioInfo();
}

function closeRatioInfo() {
  const toggle = document.querySelector("#ratioInfoToggle");
  const popover = document.querySelector("#ratioInfoPopover");
  if (!toggle || !popover) return;
  popover.hidden = true;
  toggle.setAttribute("aria-expanded", "false");
}

function initRatioInfo() {
  const toggle = document.querySelector("#ratioInfoToggle");
  const popover = document.querySelector("#ratioInfoPopover");
  if (!toggle || !popover) return;
  ...
  document.addEventListener("click", closeRatioInfo);
